...
if 'CyberBattleCBSHH-v0' in registry.env_specs:
    del registry.env_specs['CyberBattleCBSHH-v0']

register(
    id='CyberBattleCBSHH-v0',
    cyberbattle_env_identifiers=chainpattern.ENV_IDENTIFIERS,
    entry_point='cyberbattle.h_env:CyberBattleCBSHH',
    kwargs={
        'defender_agent': None,
        'attacker_goal': AttackerGoal(own_atleast_percent=1.0),
        'defender_goal': DefenderGoal(eviction=False),
    }
)